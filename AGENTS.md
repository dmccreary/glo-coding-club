# AI Agent Instructions — GLO Coding Club

Welcome, Agent. You have been asked to generate, edit, or validate content for
the **GLO Coding Club** intelligent textbook.
...
| | |
|---|---|
| Book title | GLO Coding Club |
| Published site | https://dmccreary.github.io/glo-coding-club/ |
| Repository | https://github.com/dmccreary/glo-coding-club |
...
- The published lesson URL is
  `https://dmccreary.github.io/glo-coding-club/sims/<sim-id>/`. Always
